...
uv run python -m career_match.cli.mcp_client list
uv run python -m career_match.cli.mcp_client match ../data/raw/cvs/jane_doe_backend.pdf --k 10
...
- [x] Semaine 4 : pipeline LangGraph, serveur et client MCP
